...
import io.github.lenabett.orderservice.exception.InventoryServiceException;
import io.github.lenabett.orderservice.exception.NotEnoughQuantityException;
import io.github.lenabett.orderservice.exception.OrderServiceException;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String placeOrder(OrderRequest orderRequest) {
        ...
        GenericResponse<?> response = webClient.get()
                .uri("http://localhost:o/api/inventory/check",
